...
%RIR  
% room impulse response calculation, based
% on simple model using virtual sources.
% 
%   usage: [h] = RIR(FS, MIC, N, R, RM, SRC)
%
%   FS - sample rate.
...
%      convolution.  The program FCONV.m will do this. It is
%      available at http://www.2pi.us/code/fconv.m
%   2) All distances are in meters.
%   3) A paper has been written on this model.  It is available
%      at: http://www.2pi.us/rir.html
%
%Version 3.2
